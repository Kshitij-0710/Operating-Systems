...
void sjf_premptive(struct job *j, int n, int total)
{
    ...
    while (t != total)
    {
        ...
        for (int i = 1; i <= executing.bt; i++)
        {
            ...
            // Check their burst times and get minimum
            ...
            if (executing.bt != 0)
            {
                ...
                if (min.bt < executing.bt)
                {
                    ...
                    // Bring lowest burst time job for processing
                    executing = min;
                    break;
                }
            }
